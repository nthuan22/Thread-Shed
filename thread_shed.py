...
#define an empty list daily_transactions_split
...
for transaction in daily_transactions_split:
  ...
  for section in transaction:
    transaction_clean.append(section.replace("\n", " ").strip(" "))
...
#define a variable called total_sales and set it equal to 0
total_sales = 0
...
#print out thread_sold and inspect it
#print(thread_sold)

#define an empty list thread_sold_split
thread_sold_split = []

#iterate through thread_sold list
...
white = color_count('white')
print("The total sales of the whirte thread is: " +str(white))

#Define a list called colors that stores all of the colored threads that Thread Shed offers:
colors = ['red','yellow','green','white','black','blue','purple']

#print a sentence that says how many threads of each color were sold today.
for color in colors:
  print ("Today Thread Shed has sold {0} of {1} threads".format(color_count(color), color))
